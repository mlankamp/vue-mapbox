  ...
  <v-app>
    <v-app-bar>
      <template v-slot:prepend>
        <svg width="100" height="48" viewBox="0 0 173 144" xmlns="http://www.w3.org/2000/svg" class="navigation-container__svg-icon">
      ...
      <v-app-bar-title>
        <svg width="161" height="24" viewBox="0 0 161 24" xmlns="http://www.w3.org/2000/svg" class="navigation-container__svg-text">
      ...
      <template v-slot:append>
        <v-btn text="3D Viewer" />
        <v-btn text="Downloads" />
